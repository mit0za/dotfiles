...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey, }, "q", function() awful.spawn(web_browser) end,
...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({}, "XF86AudioMute", function() awful.spawn("amixer set Master 1+ toggle", false) end),
...
awful.keyboard.append_global_keybindings({
  -- File Manager :
  awful.key({ ctrl, shift }, "f", function() awful.spawn(string.format("nautilus")) end,
  ...
  awful.key({ modkey }, "Print", function() awful.spawn("screenshot-select") end,
  ...
  --     "rofi -show drun -show-icons -theme ~/.config/awesome/libs/misc/rofi/config.rasi &>> /tmp/rofi.log") end,
  --   { description = "rofi launcher", group = "launcher" }),

  -- ClipMenu :
  awful.key({ modkey }, "Insert", function() awful.spawn("clipmenu") end,
